                            ...
                            {   !isFetching ?
                                this.props.listInvoice.map(( invoice, index) => {
                                    return  <TableRow key={index}>
                                                ...
                                                <TableCell><span style={{backgroundColor: invoice.status.color, color: "white", fontWeight: 600, padding: "3px 7px 3px 7px", borderRadius: 4}}>{ invoice.status[localStorage.getItem('locale')] }</span></TableCell>
