    ...
    return <div>
        ...
        <Paper className={classes.paper}>
            ...
            <Grid container spacing={24}>
                ...
                <Grid item xs={12} sm={6} md={6}>
                    ...
                    <Grid container spacing={8}>
                        ...
                        <Grid item xs={12} md={6} sm={6}>
                            <ApxSelect
                                arrayField={[...vat, { en: "Add a VAT...", fr: "Ajouter une TVA...", value: null, btn: true, indice: 0, new: true }] || []}
                                field="vat"
                                required={true}
                                disabled={!canBeUpdated}
            ...
            <TextField
                ...
                rows={5}
                fullWidth
                placeholder={locale.helperText.textarea_terms}
                multiline
                margin="dense"
                value={data.terms}
