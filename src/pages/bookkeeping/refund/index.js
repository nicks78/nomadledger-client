                            ...
                            {   !isFetching ?
                                this.props.listRefund.map(( refund, index) => {
                                    return  <TableRow key={index}>
                                                ...
                                                <TableCell><span style={{backgroundColor: refund.status.color, color: "white", fontWeight: 600, padding: "3px 7px 3px 7px", borderRadius: 4 }}>{ refund.status[localStorage.getItem('locale')] }</span></TableCell>
